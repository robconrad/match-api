 ...
 * @author rconrad
 */
class SetKeyServiceImplTest extends KeyServiceImplTest[SetKey] {
  ...
  val keyService = new SetKeyServiceImpl[SetKey]() {
    // scalastyle:off null
    val serviceManifest = null
    def make(id: Id)(implicit p: Pipeline) = new SetKeyImpl {

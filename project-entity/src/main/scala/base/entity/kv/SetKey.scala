 ...
 * @define false '''false'''
 */
trait SetKey[K, V] extends Key[K] {
   ...
   * @since 1.0.0
   */
  def diff(keys: SetKey[_, V]*): Future[Set[V]]
   ...
   * @since 1.0.0
   */
  def diffStore(key1: SetKey[_, V], keys: SetKey[_, V]*): Future[Long]
   ...
   * @since 1.0.0
   */
  def inter(keys: SetKey[_, V]*): Future[Set[V]]
   ...
   * @since 1.0.0
   */
  def interStore(keys: SetKey[_, V]*): Future[Long]
   ...
   * @since 1.0.0
   */
  def move(destKey: SetKey[_, V], member: V): Future[Boolean]
   ...
   * @since 1.0.0
   */
  def union(keys: SetKey[_, V]*): Future[Set[V]]
   ...
   * @since 1.0.0
   */
  def unionStore(keys: SetKey[_, V]*): Future[Long]
